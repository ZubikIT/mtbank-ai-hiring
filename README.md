...
В папке [`audio/samples/`](audio/samples/) — **10 записей реальной спонтанной русской речи с эталонными транскриптами** (демо-сэмплы речевых корпусов Nexdata):

- **4 телефонных диалога (8kHz)** — реальный телефонный канал, как в колл-центре
- **3 разговорных записи (мобильный, 16kHz)**
- **3 спонтанных монолога (16kHz)** — с паузами, «э-э» и самоисправлениями

**Обязательно:** прогоните все 10 через ваш ASR, посчитайте WER против эталонных `.txt` (например через `jiwer`) и приложите таблицу к README. Детали — в [`audio/samples/README.md`](audio/samples/README.md).
